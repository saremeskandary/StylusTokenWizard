...
<section class="controls-section">
  ...
  <div class="checkbox-group">
    ...
    <label class:checked={opts.pausable}>
      ...
      Pausable
      <!-- <HelpTooltip link="https://docs.openzeppelin.com/contracts-cairo/security#pausable"> FIXME create proper path for stylus
    ...
    <label class:checked={opts.updatableUri}>
      ...
      Updatable URI
      <!-- <HelpTooltip link="https://docs.openzeppelin.com/contracts-cairo/api/erc1155#ERC1155Component-set_base_uri"> FIXME create proper path for stylus
